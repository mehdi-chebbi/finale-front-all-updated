...
const en: Translations = {
  ...
  'filters.status.actif': 'Actif',
  'filters.status.sousEvaluation': 'Sous Évaluation',
  'filters.status.resultat': 'Résultat',
  'filters.status.cloture': 'Cloturé',
  ...
  'rh.confirm.deleteOfferText': 'This action cannot be undone. This offer will be permanently deleted.',
  ...
  'rh.status.actif': 'Actif',
  'rh.status.sousEvaluation': 'Sous Évaluation',
  'rh.status.resultat': 'Résultat',
  'rh.status.cloture': 'Cloturé',
  ...
  // Candidate selection functionality translations
  'rh.selectCandidate': 'Select Candidate',
  'rh.candidateModal.title': 'Select Candidate for Offer',
  'rh.candidateModal.subtitle': 'Enter the name of the selected candidate/company for this offer',
  'rh.candidateModal.nameLabel': 'Candidate Name *',
  'rh.candidateModal.namePlaceholder': 'Enter candidate name (company, individual, or organization name)',
  'rh.candidateModal.submit': 'Select Candidate',
  'rh.candidateModal.cancel': 'Cancel',
  'rh.candidateModal.success': '✅ Excellent! The candidate has been successfully selected and the offer status has been updated to "Resultat".',
  ...
  'rh.swal.archiveTitle': 'Archive Applications',
  'rh.swal.archiveConfirmation': 'Are you sure you want to archive all applications for "{offerTitle}"? This will download all candidate documents and mark them as archived.',
  'rh.swal.archiveConfirm': 'Yes, archive them!',
  'rh.swal.archiveCancel': 'Cancel',
  'rh.swal.archiveCompleteTitle': 'Archive Complete!',
  'rh.swal.archiveFailedTitle': 'Archive Failed',
  'rh.swal.selectionCompleteTitle': 'Candidate Selected Successfully!',
  'rh.swal.selectionCompleteText': '{successMessage} {candidate} has been chosen for the position "{offerTitle}".',
  'rh.swal.selectionFailedTitle': 'Selection Failed',
  'rh.swal.great': 'Great!',
  'rh.swal.wonderful': 'Wonderful!',
  'rh.swal.ok': 'OK',
  'rh.swal.pleaseEnterCandidateName': 'Please enter a candidate name',
  'rh.swal.archiveError': 'Failed to archive applications',
  'rh.swal.generalError': 'Error: {error}',
  ...
  // Q&A Feature translations
  'askQuestion.title': 'Ask a Question',
  'askQuestion.label': 'Your Question',
  'askQuestion.placeholder': 'Type your question here...',
  'askQuestion.help': 'Please be clear and specific about what you\'d like to know.',
  'askQuestion.submit': 'Submit Question',
  'askQuestion.success': 'Your question has been submitted successfully!',
  'askQuestion.button': 'Ask a Question',
  'askQuestion.offer': 'Regarding Offer',
  
  'faq.title': 'Frequently Asked Questions',
  'faq.question': 'Question',
  'faq.answer': 'Answer',
  'faq.noQuestions': 'No questions available.',
  'faq.close': 'Close',
  'faq.button': 'FAQ',
  'faq.error.fetchFailed': 'Failed to fetch FAQ',
  'faq.error.networkError': 'Network error. Please try again.',
  
  'answerQuestions.title': 'Answer Questions',
  'answerQuestions.subtitle': 'Review and answer questions from applicants',
  'answerQuestions.back': 'Back to Dashboard',
  'answerQuestions.questionsList': 'Questions List',
  'answerQuestions.noQuestions': 'No questions have been submitted yet.',
  'answerQuestions.answerForm': 'Answer Form',
  'answerQuestions.selectedQuestion': 'Selected Question',
  'answerQuestions.currentAnswer': 'Current Answer',
  'answerQuestions.yourAnswer': 'Your Answer',
  'answerQuestions.answerPlaceholder': 'Type your answer here...',
  'answerQuestions.askedOn': 'Asked on',
  'answerQuestions.submitAnswer': 'Submit Answer',
  'answerQuestions.selectQuestion': 'Select a question from the list to answer it',
  'answerQuestions.answered': 'Answered',
  'answerQuestions.unanswered': 'Unanswered',
  'answerQuestions.button': 'Answer Questions',
  'answerQuestions.error.fetchFailed': 'Failed to fetch questions',
  'answerQuestions.error.submitFailed': 'Failed to submit answer',
  'answerQuestions.error.networkError': 'Network error. Please try again.',
  
  'form.error.questionRequired': 'Question is required',
  'form.error.submitQuestionFailed': 'Failed to submit question',
  'form.error.networkError': 'Network error. Please try again.',
  
  // Button and status messages for Comité d'Ouverture dashboard
  'rh.button.answerQuestions': 'Answer questions from applicants',
  'rh.button.offerExpired': 'Offer expired - questions disabled',
  'rh.button.questionsNotAvailable': 'Questions not available',
  'rh.button.archiveDisabled': 'Offer still active - archive disabled',
  'rh.button.downloadDocuments': 'Download all candidate documents for this offer',
  'rh.button.archiving': 'Archiving...',
  'rh.button.archiveClosed': 'Archive Closed',
  'rh.button.candidateNotAvailable': 'Candidate already selected or not available',
  'rh.button.edit': 'Edit',
...
const fr: Translations = {
  ...
  'admin.confirmDeleteUser': 'Supprimer cet utilisateur ?',
  ...
  'rh.type': 'Catégorie',
  'rh.allTypes': 'Toutes les catégories',
  'rh.country': 'Pays',
  ...
  // Candidate selection functionality translations
  'rh.selectCandidate': 'Sélectionner le Candidat',
  'rh.candidateModal.title': 'Sélectionner le Candidat pour l\'Offre',
  'rh.candidateModal.subtitle': 'Entrez le nom du candidat/entreprise sélectionné pour cette offre',
  'rh.candidateModal.nameLabel': 'Nom du Candidat *',
  ...
  'rh.swal.archiveConfirmation': 'Êtes-vous sûr de vouloir archiver toutes les candidatures pour "{offerTitle}" ? Cela téléchargera tous les documents des candidats et les marquera comme archivées.',
  'rh.swal.archiveConfirm': 'Oui, les archiver !',
  'rh.swal.archiveCancel': 'Annuler',
  'rh.swal.archiveCompleteTitle': 'Archivage Terminé !',
  'rh.swal.archiveFailedTitle': 'Échec de l\'Archivage',
  'rh.swal.selectionCompleteTitle': 'Candidat Sélectionné avec Succès !',
  'rh.swal.selectionCompleteText': '{successMessage} {candidate} a été choisi pour le poste "{offerTitle}".',
  'rh.swal.selectionFailedTitle': 'Échec de la Sélection',
  'rh.swal.great': 'Excellent !',
  'rh.swal.wonderful': 'Merveilleux !',
  'rh.swal.ok': 'OK',
  'rh.swal.pleaseEnterCandidateName': 'Veuillez entrer le nom du candidat',
  'rh.swal.archiveError': 'Échec de l\'archivage des candidatures',
  'rh.swal.generalError': 'Erreur : {error}',
  ...
  // Q&A Feature translations
  'askQuestion.title': 'Poser une Question',
  'askQuestion.label': 'Votre Question',
  'askQuestion.placeholder': 'Tapez votre question ici...',
  'askQuestion.help': 'Soyez clair et spécifique sur ce que vous aimeriez savoir.',
  'askQuestion.submit': 'Soumettre la Question',
  'askQuestion.success': 'Votre question a été soumise avec succès!',
  'askQuestion.button': 'Poser une Question',
  'askQuestion.offer': 'Concernant l\'offre',
  
  'faq.title': 'Questions Fréquemment Posées',
  'faq.question': 'Question',
  'faq.answer': 'Réponse',
  'faq.noQuestions': 'Aucune question n\'est encore disponible.',
  'faq.close': 'Fermer',
  'faq.button': 'FAQ',
  'faq.error.fetchFailed': 'Échec de récupération de la FAQ',
  'faq.error.networkError': 'Erreur réseau. Veuillez réessayer.',
  
  'answerQuestions.title': 'Répondre aux Questions',
  'answerQuestions.subtitle': 'Examiner et répondre aux questions des candidats',
  'answerQuestions.back': 'Retour au Tableau de Bord',
  'answerQuestions.questionsList': 'Liste des Questions',
  'answerQuestions.noQuestions': 'Aucune question n\'a encore été soumise.',
  'answerQuestions.answerForm': 'Formulaire de Réponse',
  'answerQuestions.selectedQuestion': 'Question Sélectionnée',
  'answerQuestions.currentAnswer': 'Réponse Actuelle',
  'answerQuestions.yourAnswer': 'Votre Réponse',
  'answerQuestions.answerPlaceholder': 'Tapez votre réponse ici...',
  'answerQuestions.askedOn': 'Posée le',
  'answerQuestions.submitAnswer': 'Soumettre la Réponse',
  'answerQuestions.selectQuestion': 'Sélectionnez une question dans la liste pour y répondre',
  'answerQuestions.answered': 'Répondue',
  'answerQuestions.unanswered': 'Sans réponse',
  'answerQuestions.button': 'Répondre aux Questions',
  'answerQuestions.error.fetchFailed': 'Échec de récupération des questions',
  'answerQuestions.error.submitFailed': 'Échec de soumission de la réponse',
  'answerQuestions.error.networkError': 'Erreur réseau. Veuillez réessayer.',
  
  'form.error.questionRequired': 'La question est requise',
  'form.error.submitQuestionFailed': 'Échec de soumission de la question',
  'form.error.networkError': 'Erreur réseau. Veuillez réessayer.',
  
  // Button and status messages for Comité d'Ouverture dashboard
  'rh.button.answerQuestions': 'Répondre aux questions des candidats',
  'rh.button.offerExpired': 'Offre expirée - questions désactivées',
  'rh.button.questionsNotAvailable': 'Questions non disponibles',
  'rh.button.archiveDisabled': 'Offre toujours active - archive désactivé',
  'rh.button.downloadDocuments': 'Télécharger tous les documents des candidats pour cette offre',
  'rh.button.archiving': 'Archivage...',
  'rh.button.archiveClosed': 'Archive Fermé',
  'rh.button.candidateSelected': 'Candidat sélectionné: {candidate}',
  'rh.button.offerMustExpire': 'L\'offre doit expirer avant de sélectionner un candidat',
  'rh.button.candidateNotAvailable': 'Candidat déjà sélectionné ou non disponible',
  'rh.button.edit': 'Modifier',
